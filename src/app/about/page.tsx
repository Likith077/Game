...
const About = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-6">About Game Space</h1>
      <p className="mb-4">
        Welcome to Game Space, your ultimate destination for quick, fun, and engaging mini-games!
      </p>
      <p className="mb-4">
      ...
      <p>
        Join our growing community of gamers and start your adventure today. 
        At Game Space, the fun never stops!
      </p>
    </div>
  )
}
